...
The time delay is the killer feature. You pour, walk away, and the smoke starts on its own. This makes it useful for photography and film (atmospheric fog effects), paintball and airsoft (smoke screens), wilderness signaling, and — if we're being honest — looking absolutely incredible on camera.
...
- [ ] Ceramic or metal container — to hold the reaction (NOT plastic — it melts) *(hardware store, kitchen supply)*
- [ ] Long-reach lighter or fuse (backup ignition, usually not needed) *(dollar store)*
...
3. **Add the pool shock.** Pour 2-3 tablespoons of granular calcium hypochlorite into the container. Spread it into a shallow, even layer — this increases the surface area for the reaction.
4. **Add the brake fluid.** Pour about 1 tablespoon of DOT 3 brake fluid onto the pool shock granules. Pour from a distance — do not bring your face close to the container. Cap the brake fluid bottle immediately and move it at least 20 feet away.
5. **Walk away immediately.** Move upwind and at least 15 feet from the container. The reaction begins in 30-90 seconds. You'll see the granules start to fizz and darken, then wisps of white smoke, then a sudden vigorous eruption of thick white smoke. The delay varies with ambient temperature (faster in heat) and the specific calcium hypochlorite concentration.
6. **Observe from a safe distance.** The smoke column builds rapidly and sustains for 2-5 minutes. In still air, it rises vertically in a dramatic pillar. In wind, it disperses laterally as a thick ground-level fog. Do not approach the container while it's active — the reaction generates extreme heat and toxic fumes.
