...
3. **Disconnect the internal video and deflection circuits.** Unplug the yoke connectors from the main board. The TV's scanning circuits normally drive these coils with sawtooth waves to raster-scan the beam across the screen. You're replacing those signals with your own. Leave the flyback transformer and high-voltage section connected — you still need the electron gun powered and the beam energized. The CRT needs to be "on" but with no video signal.

4. **Wire external audio to the deflection coils.** Connect the left channel of a stereo audio amplifier to the horizontal deflection coil. Connect the right channel to the vertical deflection coil. Start with very low volume — the deflection coils are low-impedance loads (typically 5-15 ohms), so even a few watts of audio power will drive the beam across the full screen. The amplifier is now your XY controller: left channel moves the beam horizontally, right channel moves it vertically.
...
- [CRT Electromagnetic Art](../art-and-installation/048-crt-electromagnetic-art.md) — single-CRT version of this concept with deeper magnet experiments
