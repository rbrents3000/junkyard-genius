...
- [Cloud Chamber](/categories/mad-scientist/041-cloud-chamber/) — the standalone benchtop version using dry ice
- [DIY Freeze Dryer](/categories/fridge-and-cooling/094-diy-freeze-dryer/) — another build that repurposes a fridge compressor for extreme cooling
