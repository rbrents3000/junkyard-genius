...
- **Flashback arrestors are mandatory, not optional.** A flame traveling backward down a propane line into the manifold or tank is catastrophic. Install one between the tank and the manifold at minimum. Individual arrestors at each nozzle are better.
