...
5. **Collect hydrogen.** Place an inverted water-filled bottle over the cathode. As hydrogen bubbles rise, they displace the water and fill the bottle. Alternatively, attach tubing to a funnel over the cathode and route it into a balloon.
6. **Test for hydrogen.** Hold a lit match or lighter at the mouth of an inverted bottle of collected gas. Pure hydrogen ignites with a quiet "pop" and an almost invisible flame. If the gas detonates loudly, it's mixed with oxygen (a dangerous mix — see safety notes).
