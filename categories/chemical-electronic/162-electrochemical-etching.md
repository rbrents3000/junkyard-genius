...
- [ ] Cotton pads or Q-tips — the applicator *(pharmacy)*
- [ ] Alligator clips and wire *(electronics supplier)*
- [ ] Stencil material — vinyl sticker, nail polish, or laser-printed transparency *(craft store)*
...
3. **Wire the circuit.** Connect one alligator clip to the positive terminal of the 9V battery and clip it to the metal object (the object is the anode). Connect the other clip to the negative terminal and clip it to a cotton pad soaked in salt water.
4. **Etch the design.** Press the salt-water-soaked cotton pad against the stenciled area. Hold it firmly for 10-30 seconds. You'll see bubbles forming and the exposed metal darkening. Re-soak the pad in salt water and repeat 3-5 times for a deeper etch.
5. **Check your progress.** After a few applications, peel back a corner of the stencil to check etch depth. For a subtle mark, 30 seconds total is enough. For a deep, visible etch, 2-3 minutes total may be needed.
