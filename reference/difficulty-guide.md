...
<p align="center">
  <img src="../images/reference/difficulty.jpg" alt="Difficulty & Ratings Guide" width="700" />
</p>
...
```mermaid
flowchart TD
    S1["⭐ Chill"] --> G1["Safety glasses"]
    S2["⭐⭐ Mildly Sketchy"] --> G2["Safety glasses\nGloves\nVentilation"]
    S3["⭐⭐⭐ Respect It"] --> G3["Full PPE\nMultimeter\nFire extinguisher"]
    S4["⭐⭐⭐⭐ One Wrong Move"] --> G4["Full PPE + face shield\nRubber mat\nBuddy system"]
    S5["⭐⭐⭐⭐⭐ Call Next of Kin"] --> G5["Everything above\nDead man's switch\nHospital route planned"]
